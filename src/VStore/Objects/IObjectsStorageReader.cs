...
namespace NuClear.VStore.Objects
{
    public interface IObjectsStorageReader
    {
        ...
        Task<IReadOnlyCollection<ObjectMetadataRecord>> GetObjectsMetadata(IReadOnlyCollection<long> ids);
        ...
        Task<VersionedObjectDescriptor<long>> GetObjectLatestVersion(long id);
